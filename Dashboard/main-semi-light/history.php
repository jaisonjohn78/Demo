                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu animated flipInX">
                                <li class="user-body">
                                    <a class="dropdown-item" href="admin.php"><i class="ti-user text-muted me-2"></i>
                                    Dashboard</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 text-center my-2">
                                    ...
                                    <h1 class="fw-500 m-0 text-center"><i
                                            class="mx-3 mdi mdi-clock btn-rounded btn-info down_box">
                                        </i> History</h1>
                                </div>
                            </div>
                            <div class="row mt-55">
