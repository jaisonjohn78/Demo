...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="container">
                <h3 class="transition_heading">Update Transaction Detail and Status</h3>
                <hr>
                <!-- Main content -->
                <form method="post" action="" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Amount:</label>
                        <input type="text" name="amount" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $amount ?>" placeholder="Amount">
                        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                    </div>
                    <div class="form-group">
                        <select name="status" style="width:72vw;padding:7px;border-radius:5px;border:1px solid #86a4c3;">
                            <option selected disabled >Select Transition Status</option>
