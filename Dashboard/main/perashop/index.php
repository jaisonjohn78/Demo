    ...
    <div id="perashop">
        <section class="section is-medium is-darkest">
            ...
            <div class="container">
                ...
                <div class="divider is-centered"></div>
                <!-- Title -->
                <h2 class="title is-light is-semibold has-text-centered is-spaced">Perashop</h2>
                ...
                <div class="content-wrapper is-large">
                    ...
                    <div class="columns is-vcentered">
                        <div class="column is-5">
                            ...
                            <div class="side-feature-content">
                                <!-- Title -->
                                <h3 class="title is-4 is-light"><img src="img/icons/ico/bitnetwork.svg" alt=""> <span>Convert</span></h3>
                                <!-- Divider -->
                                <div class="divider is-long"></div>
                                <p class="is-light"><label>BTC</label><input type="number"  style="margin: 15px ;"></p>
                                <p class="is-light"><label>USD</label><input type="number"  style="margin: 15px ;" width="5rem"></p>
                            </div>
